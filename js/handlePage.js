...
// ministerChev.addEventListener("click", e => {
//   console.log(ministerChev);
//   if ((ministerVisibility = false)) {
//     console.log(ministerTab);
//     ministerTab.style.display = "block";
//     ministerVisibility = true;
//   } else {
//     ministerTab.style.display = "none";
//     ministerVisibility = false;
//   }
// });
